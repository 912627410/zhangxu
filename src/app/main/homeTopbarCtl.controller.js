(function () {
  ...
  angular
    .module('GPSCloud')
    .controller('homeTopbarController', homeTopbarController);

  /** @ngInject */
  function homeTopbarController($rootScope, $cookies, $scope, $window, $http, $uibModal, permissions, Notification, Idle, $stateParams, Keepalive, $translate, languages) {
    var vm = this;
