...
(function(){
  'use strict'
  angular.module('GPSCloud').controller('rentalNewOrgController',rentalNewOrgController);

  function rentalNewOrgController($scope,$uibModalInstance,RENTAL_ORG_URL,serviceResource,Notification,selectedOrg) {
    var vm= this;
    ...
    vm.ok= function(newOrg){
      ...
      var restPromise =serviceResource.restAddRequest(RENTAL_ORG_URL,newOrg);
