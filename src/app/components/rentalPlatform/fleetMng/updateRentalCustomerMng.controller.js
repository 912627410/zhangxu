...
(function() {
  ...
  /** @ngInject */
  function updateRentalCustomerController($rootScope,$scope,$http,$confirm,$location,$stateParams,treeFactory,serviceResource,RENTAL_CUSTOMER_URL, Notification) {
    var vm = this;
