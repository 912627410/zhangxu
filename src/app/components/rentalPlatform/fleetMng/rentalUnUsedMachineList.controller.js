...
(function () {
  ...
  angular
    .module('GPSCloud')
    .controller('rentalUnUsedMachineListController', rentalUnUsedMachineListController);

  /** @ngInject */
  function rentalUnUsedMachineListController($scope, $window, $location,$uibModalInstance,$filter, $anchorScroll, languages,serviceResource,NgTableParams,ngTableDefaults,Notification,treeFactory,commonFactory,permissions,rentalService,DEFAULT_SIZE_PER_PAGE,selectUrl) {
    var vm = this;
