/**
 * Created by mengwei on 17-9-29.
 */

(function() {
  'use strict';
  var GPSCloudModule = angular.module('GPSCloud');
  GPSCloudModule.directive('demoTrackedTable',demoTrackedTable);
  ...
  GPSCloudModule.directive("demoTrackedTableRow", demoTrackedTableRow);
  ...
  GPSCloudModule.directive("demoTrackedTableCell", demoTrackedTableCell);
