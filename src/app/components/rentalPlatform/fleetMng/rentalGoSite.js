(function () {
  ...
  function rentalGoSiteController($rootScope, $uibModalInstance, RENTAL_MACHINE_MONITOR_URL, ngTableDefaults, NgTableParams, serviceResource, treeFactory, rentalOrder, commonFactory,$timeout,
