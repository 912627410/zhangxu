...
(function () {
  ...
  /** @ngInject */
  function rentalFenceMngController($scope, $window, $location, $anchorScroll, serviceResource,NgTableParams,ngTableDefaults,Notification,permissions,fleetTreeFactory,DEFAULT_SIZE_PER_PAGE,MACHINE_PAGE_URL) {
    var vm = this;
