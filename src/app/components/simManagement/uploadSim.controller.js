...
(function () {
  ...
  /** @ngInject */
  function uploadSimController($scope,$timeout,$http,languages, $uibModalInstance,Upload, SIM_UPLOAD_URL,serviceResource, Notification, operatorInfo,SIM_UPLOADTEMPLATE_DOWNLOAD_URL) {
    var vm = this;
        ...
        file.upload.then(function (response) {
          $timeout(function () {
            ...
            if (vm.errorList.length > 0){
              vm.operMsg = languages.findKey('exceptionDataExists');
            }else{
              vm.operMsg = languages.findKey('uploadedSuccessfully');
            }
