...
(function () {
  ...
  /** @ngInject */
  function machineWorkTimeController($rootScope, $scope, $http, $filter,Notification) {

    //初始化
    var barChart = echarts.init(document.getElementById('barChartContainer'));

    var data = [
      [[200,2,'machine'],[400,4,'machine'],[700,5,'machine'],[700,5,'machine'],[1800,10,'machine'],[3000,17,'machine'],[400,3,'machine'],[222,1,'machine'],[589,6,'machine'],[999,9,'machine'],[1555,7,'machine']]
    ];
