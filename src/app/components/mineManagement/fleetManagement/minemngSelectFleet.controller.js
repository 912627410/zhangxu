...
(function () {
    ...
    angular
        .module('GPSCloud')
        .controller('minemngSelectFleetController', minemngSelectFleetController);

    function minemngSelectFleetController(serviceResource,MINE_MACHINE_FLEET,MINE_MACHINE_FLEET_LIST,$rootScope, $scope, $timeout, $confirm, $filter, $uibModalInstance) {
      var vm = this;
      ...
      vm.getUpdateObject = function () {
        var promise = serviceResource.restCallService(MINE_MACHINE_FLEET_LIST, "QUERY");
