...
(function () {
    ...
    function minemngUpdateWorkFaceController($scope, $uibModalInstance,MINEMNG_WORKFACE ,workFace, serviceResource ,Notification) {
      var vm =this;
      ...
      vm.ok=function () {
        ...
        var restPromise =serviceResource.restUpdateRequest(MINEMNG_WORKFACE,vm.workFace);
