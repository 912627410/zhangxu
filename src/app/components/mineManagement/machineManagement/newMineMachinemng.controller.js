...
(function () {
  ...
  angular
    .module('GPSCloud')
    .controller('newMineMachinemngController', newMineMachinemngController);

  /** @ngInject */
  function newMineMachinemngController(machineService,$http, $uibModalInstance,languages, DEIVCIE_FETCH_UNUSED_URL,MINE_MACHINE_URL, serviceResource, Notification) {
    var vm = this;
