...
(function () {
  ...
  angular
    .module('GPSCloud')
    .controller('newHaulotteMachineController', newHaulotteMachineController);

  /** @ngInject */
  function newHaulotteMachineController($rootScope,$scope,machineService,$http,$timeout,AMAP_PLACESEARCH_URL, $uibModal,$uibModalInstance,languages,treeFactory, DEIVCIE_FETCH_UNUSED_URL,MACHINE_URL,ENGINE_TYPE_LIST_URL, serviceResource,rentalService, Notification, operatorInfo,machineTypeInfo) {
    var vm = this;
