...
(function() {
  ...
  angular
    .module('GPSCloud')
    .controller('updateHaulotteMachineController', updateHaulotteMachineController);

  /** @ngInject */
  function updateHaulotteMachineController(rentalService,$rootScope,$scope,$http,$confirm,$timeout,$uibModalInstance,languages,treeFactory,machineService,DEIVCIE_FETCH_UNUSED_URL,AMAP_PLACESEARCH_URL,MACHINE_URL,ENGINE_TYPE_LIST_URL,serviceResource, Notification,machine,machineTypeInfo,roles) {
    var vm = this;
    vm.machine = machine;
