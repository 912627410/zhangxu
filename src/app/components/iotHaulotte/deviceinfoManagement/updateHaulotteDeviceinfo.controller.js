...
(function () {
  ...
  angular
    .module('GPSCloud')
    .controller('updateHaulotteDeviceinfoController', updateHaulotteDeviceinfoController);

  /** @ngInject */
  function updateHaulotteDeviceinfoController($rootScope, $scope,$http,$uibModal, $uibModalInstance, treeFactory,SIM_FETCH_UNUSED_URL, DEVCE_HIGHTTYPE,DEVCE_POWERTYPE,DEVCE_MF,
